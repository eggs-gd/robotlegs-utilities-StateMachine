...
package robotlegs.bender.util.statemachine.events {
    ...
    /**
     * Event with data about transition between states
     */
    public class TransitionEvent extends Event {
        ...
        public function TransitionEvent(eventType:String, targetState:String = null) {
        ...
        override public function clone():Event {
            return new TransitionEvent(type, _targetState);
        }
    }
}